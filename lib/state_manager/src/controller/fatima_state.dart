...
typedef FatimaControllerBuilder<T extends LifeCycleMixin> = Widget Function(
    T controller);
...
class FatimaBuilder<T extends Controller> extends StatelessWidget {
  final FatimaControllerBuilder<T> builder;
  final bool global;
  final Object? id;
  final String? tag;
  ...
  Widget build(BuildContext context) {
    ...
    // return widFatima.builder(controller!);
  }
}
...
/// methods (like Fatima.to()) have a `binding` property that takes an
/// instance of Bindings to manage the
/// dependencies() (via Fatima.put()) for the Route you are opening.
