...
class Storage {
  factory Storage(
      [String container = 'Storage',
      String? path,
      Map<String, dynamic>? initialData]) {
    if (_sync.containsKey(container)) {
      return _sync[container]!;
    } else {
      final instance = Storage._internal(container, path, initialData);
      _sync[container] = instance;
      return instance;
    }
  }

  Storage._internal(String key,
  ...
  static final Map<String, Storage> _sync = {};
  ...
  static Future<bool> init([String container = 'Storage']) {
    WidgetsFlutterBinding.ensureInitialized();
    return Storage(container).initStorage;
  }
