...
String? _extractRouteName(Route? route) {
  ...
  if (route is FatimaModalBottomSheetRoute) {
...
class GetObserver extends NavigatorObserver {
  ...
  void didPop(Route route, Route? previousRoute) {
    ...
    //   // Fatima.log("CLOSE SNACKBAR ${currentRoute.name}");
    //   Fatima.log("CLOSE SNACKBAR");
    // } else

    if (currentRoute.isBottomSheet || currentRoute.isDialog) {
      Fatima.log("CLOSE ${currentRoute.name}");
    } else if (currentRoute.isGetPageRoute) {
      Fatima.log("CLOSE TO ROUTE ${currentRoute.name}");
    }
  ...
  void didPush(Route route, Route? previousRoute) {
    ...
    //   // Fatima.log("OPEN SNACKBAR ${newRoute.name}");
    //   Fatima.log("OPEN SNACKBAR");
    // } else

    if (newRoute.isBottomSheet || newRoute.isDialog) {
      Fatima.log("OPEN ${newRoute.name}");
    } else if (newRoute.isGetPageRoute) {
      Fatima.log("GOING TO ROUTE ${newRoute.name}");
    }
  ...
  void didRemove(Route route, Route? previousRoute) {
    ...
    Fatima.log("REMOVING ROUTE $routeName");
  ...
  void didReplace({Route? newRoute, Route? oldRoute}) {
    ...
    Fatima.log("REPLACE ROUTE $oldName");
    Fatima.log("NEW ROUTE $newName");
    ...
    if (oldRoute is FatimaPageRoute) {
