...
mixin FatimaPageRouteTransitionMixin<T> on PageRoute<T> {
...
Cannot read the previousTitle for a route that has not yet been installed''',
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    // fullscreen dialog.
    return (nextRoute is FatimaPageRouteTransitionMixin &&
  ...
  static bool canSwipe(FatimaPageRoute route) =>
      route.popGesture ?? Fatima.defaultPopGesture;
  ...
  static Widget buildPageTransitions<T>(
    ...
    final route = rawRoute as FatimaPageRoute<T>;
    final linearTransition =
        CupertinoRouteTransitionMixin.isPopGestureInProgress(route);
    final finalCurve = route.curve ?? Fatima.defaultTransitionCurve;
    ...
    if (route.fullscreenDialog && route.transition == null) {
      ...
      switch (route.transition ?? Fatima.defaultTransition) {
  ...
  static bool _isPopGestureEnabled<T>(
    ...
    if (FatimaPageRouteTransitionMixin.isPopGestureInProgress(context)) {
      return false;
    }
