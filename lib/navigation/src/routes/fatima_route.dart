...
class FatimaPage<T> extends Page<T> {
  ...
  final List<FatimaPage> children;
  final List<FatimaMiddleware>? middlewares;
  ...
  FatimaPage({
    ...
    this.children = const <FatimaPage>[],
    this.middlewares,
    this.unknownRoute,
    this.arguments,
  ...
  bool operator ==(Object other) {
    ...
    return other is FatimaPage<T> && other.key == key;
  }
