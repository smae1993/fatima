...
extension ExtensionBottomSheet on FatimaInterface {
  Future<T?> bottomSheet<T>(
    ...
    return Navigator.of(overlayContext!, rootNavigator: useRootNavigator)
        .push(FatimaModalBottomSheetRoute<T>(
...
extension ExtensionDialog on FatimaInterface {
  /// Show a dialog.
  ...
  Future<T?> generalDialog<T>(
    ...
    final key = navigatorKey ?? Fatima.nestedKey(id)?.navigatorKey;
...
extension ExtensionSnackbar on FatimaInterface {
  SnackbarController rawSnackbar({
    ...
    final getSnackBar = FatimaSnackBar(
  ...
  SnackbarController showSnackbar(FatimaSnackBar snackbar) {
...
//   }
  ...
  /// dialog is closed
  void until(bool Function(FatimaPage<dynamic>) predicate, {int? id}) {
  ...
  Future<T?>? offNamedUntil<T>(
    String page,
    bool Function(FatimaPage<dynamic>)? predicate, {
    int? id,
    dynamic arguments,
    Map<String, String>? parameters,
  }) {
  ...
  FatimaDelegate searchDelegate(dynamic k) {
    FatimaDelegate _key;
    if (k == null) {
      _key = Fatima.rootController.rootDelegate;
    } else {
...
extension OverlayExt on FatimaInterface {
  Future<T> showOverlay<T>({
    ...
    final navigatorState =
        Navigator.of(Fatima.overlayContext!, rootNavigator: false);
