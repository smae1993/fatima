...
class SnackbarController {
  ...
  void _configureOverlay() {
    final overlayContext = Fatima.overlayContext;
    _isTesting = overlayContext == null;
    _overlayState =
        _isTesting ? OverlayState() : Overlay.of(Fatima.overlayContext!);
